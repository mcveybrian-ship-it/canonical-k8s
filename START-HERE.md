...
| **05** | Harden hosts — Pro, FIPS, STIG | [`docs/runbook.md`](docs/runbook.md) **§6.0 is the ordered procedure**; §6.1–6.3c is the reference | **IN PROGRESS** — `svc-harbor-01` **COMPLETE 2026-09-10**: 51/68 → **210 pass / 7 fail**, and the 7 are policy decisions, not defects. Next: `svc-mgmt-01`, then `svc-repo-01`, then `host-4` (§6.3 explains that order). **Five decisions outstanding** — ufw, GRUB password, SSSD ×2, and the `encrypt_partitions` write-up. See `docs/open-questions.md` |
