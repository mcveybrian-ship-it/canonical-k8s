...
| **03** | libvirt on host-4, compose `svc-mgmt-01` by hand | [`docs/03-host-services.md`](docs/03-host-services.md) | **IN PROGRESS** — apt + libvirt done on host-4 2026-09-02. Bridge, data LVs and pool outstanding. libvirt, not LXD - runbook §2.6 |
