...
| **13** | ⚠️ **THE AO PACKAGE IS SIX QUESTIONS, NOT FIVE — send as ONE thread** | **Q20** unattended boot / TPM 2.0 (needed BEFORE production hardware is specified) · **Q25** five NR controls needing a signature · **Q26** notification, 34 alert rules firing at a screen nobody watches at 03:00 · **Q27** Trivy DB dated 2026-09-08 · **Q28** `esm-apps` off enclave-wide · **and the reference clock** (runbook §6.3 - a GPS/radio stratum-0 source closes both chrony rules on host-4 with no client changes). Sending them one at a time is how this takes six weeks instead of one |
