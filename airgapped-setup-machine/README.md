...
| — | 3 scanner bugs | ⚠️ `V-270663`, `V-270729`, `V-270732` throw `InvokeMethodOnNull` and land as **Not Reviewed** — they fail safe, but they are **manual reviews on every machine** |
